...
## Fourth Spin
Added the IR sensor (Follow the pin connections from <A href="https://github.com/jouellnyc/infrared_tag">here</A>) and integrated that with the current simple car api. After correcting the left and right turns, the api was complete and minimally viable. The car can move forward, backward, turn left and turn right. This was overall a success and leaves plenty of opportunities to build upon.
